...
def get_configuration_features(configuration: Configuration,
    ...
    token_parent.append(configuration.get_stack(0))
    token_parent.append(configuration.get_stack(1))
    token_parent.append(configuration.get_stack(2))
    token_parent.append(configuration.get_buffer(0))
    token_parent.append(configuration.get_buffer(1))
    token_parent.append(configuration.get_buffer(2))

    token_child.append(configuration.get_left_child(token_parent[0], 1))
    token_child.append(configuration.get_right_child(token_parent[0], 1))
    token_child.append(configuration.get_left_child(token_parent[0], 2))
    token_child.append(configuration.get_right_child(token_parent[0], 2))

    token_child.append(configuration.get_left_child(token_parent[1], 1))
    token_child.append(configuration.get_right_child(token_parent[1], 1))
    token_child.append(configuration.get_left_child(token_parent[1], 2))
    token_child.append(configuration.get_right_child(token_parent[1], 2))

    token_child.append(configuration.get_left_child(configuration.get_left_child(token_parent[0], 1), 1))
    token_child.append(configuration.get_right_child(configuration.get_right_child(token_parent[0], 1), 1))
    token_child.append(configuration.get_left_child(configuration.get_left_child(token_parent[1], 1), 1))
    token_child.append(configuration.get_right_child(configuration.get_right_child(token_parent[1], 1), 1))

    tokens = token_parent + token_child

    word_features = [vocabulary.get_word_id(configuration.get_word(token)) for token in tokens]
    pos_tag_features = [vocabulary.get_pos_id(configuration.get_pos(token)) for token in tokens]
    label_features = [vocabulary.get_label_id(configuration.get_label(token)) for token in token_child]
    features = word_features + pos_tag_features + label_features
